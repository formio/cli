...
module.exports = function(template, next) {
    ...
    console.log('');
    console.log('This application requires Office 365. We need to ask a few questions about your Azure application. See http://help.form.io/integrations/#office365 for help.');
